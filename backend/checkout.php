...
function getOrderString(){
	...
	if($_GET["priority"] == "true" && $_GET["streaming"] == "true"){
        $orderStr .= " This Order will be prioritized & streamed!";
    } else if($_GET["priority"] == "true"){
        $orderStr .= " This Order will be prioritized!";
	} else if($_GET["streaming"] == "true"){
        $orderStr .= " This Order will be streamed!";
    }
...
<form class="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" id="paypal_form">
    ...
    <input type="hidden" name="cancel_return" value="https://tftboost.net/"/>
